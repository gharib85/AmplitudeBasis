...
Times|Plus,If[Cases[Flatten[gaugefactor//.{Plus->List,Times->List}],_\[Lambda]|_del3|_del8n|_fabc|_dabc|_eps3f|_eps3a]==={},If[Cases[Flatten[gaugefactor//.{Plus->List,Times->List}],_\[Tau]|_del2|_eps3n|_del3n|_eps2f|_eps2a]=!={},FindGaugeCoord[SU2,gaugefactor][[-1]]],FindGaugeCoord[SU3,gaugefactor][[-1]]],_,{gaugefactor}]];
