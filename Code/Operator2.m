...
Do[Do[si2pair=Subsets[pa,{si2num}];sipair=Complement[pa,#]&/@si2pair;Do[AppendTo[fermtensor2,TensorProduct@@(sigma2[Subscript[\[Psi], #[[1]]],Subscript[\[Psi], #[[2]]]]&/@si2pair[[inum]])];AppendTo[fermother2,Times@@(ch\[Psi][Subscript[\[Psi], #[[1]]],1,Subscript[\[Psi], #[[2]]]]&/@sipair[[inum]])];AppendTo[fermcont2,Table[{Indices+Length[fermcur[1/2][[1]]]+i,Indices+Length[fermcur[1/2][[1]]]+i+1},{i,1,2Length[si2pair[[inum]]]-1,2}]],{inum,Length[si2pair]}],{si2num,0,2}],{pa,fermionpair}];(*Print[{fermtensor2,fermcont2,fermother2}];*)fermtensor=Join[fermtensor[[;;-l\[Gamma]-1]],Outer[TensorProduct,fermtensor[[-l\[Gamma];;]],fermtensor2]//Flatten];fermother=Join[fermother[[;;-l\[Gamma]-1]],Times[#,fermother2]&/@fermother[[-l\[Gamma];;]]//Flatten];fermcont=Join[fermcont[[;;-l\[Gamma]-1]],Flatten[Outer[Join,fermcont[[-l\[Gamma];;]],fermcont2,1],1]];fermtensor2=fermother2=fermcont2={},{lcur,fermcur[-1/2]}],(**********IF*********)Do[fermionpair=MapThread[{#1,#2}&,#]&/@(Append[fermcur[-1/2],#]&/@Permutations[lcur]);Do[AppendTo[fermtensor,TensorProduct@@(sigma[Subscript[\[Psi], #[[1]]],Subscript[\!\(\*OverscriptBox[\(\[Psi]\), \(_\)]\), #[[2]]]]&/@pa)];AppendTo[fermother,1];AppendTo[fermcont,Table[{Indices+i},{i,Length[pa]}]],{pa,fermionpair}];l\[Gamma]=Length@fermionpair;(*Print[fermionpair];*)(*Print[{fermtensor,fermcont,fermother}];*)fermionpair=Union@Map[Union,Partition[#,2]&/@Permutations[Complement[hpart[1/2],lcur]],2];(*Print[fermionpair];*)If[Length[fermcur[1/2]]>1,Do[Do[si2pair=Subsets[pa,{si2num}];sipair=Complement[pa,#]&/@si2pair;Do[AppendTo[fermtensor2,TensorProduct@@(sigma2[Subscript[\!\(\*OverscriptBox[\(\[Psi]\), \(_\)]\), #[[1]]],Subscript[\!\(\*OverscriptBox[\(\[Psi]\), \(_\)]\), #[[2]]]]&/@si2pair[[inum]])];AppendTo[fermother2,Times@@(ch\[Psi][Subscript[\!\(\*OverscriptBox[\(\[Psi]\), \(_\)]\), #[[1]]],1,Subscript[\!\(\*OverscriptBox[\(\[Psi]\), \(_\)]\), #[[2]]]]&/@sipair[[inum]])];AppendTo[fermcont2,Table[{Indices+Length[fermcur[1/2][[1]]]+i,Indices+Length[fermcur[1/2][[1]]]+i+1},{i,1,2Length[si2pair[[inum]]]-1,2}]],{inum,Length[si2pair]}],{si2num,0,2}],{pa,fermionpair}];(*Print["{fermtensor2,fermcont2,fermother2}=",{fermtensor2,fermcont2,fermother2}];Print["before=",fermtensor];*)(*fermtensor[[-l\[Gamma];;]]=Outer[TensorProduct,fermtensor[[-l\[Gamma];;]],fermtensor2]//Flatten;*)fermtensor=Join[fermtensor[[;;-l\[Gamma]-1]],Outer[TensorProduct,fermtensor[[-l\[Gamma];;]],fermtensor2]//Flatten];
(*Print["after=",fermtensor];*)(*fermother[[-l\[Gamma];;]]=Times[#,fermother2]&/@fermother[[-l\[Gamma];;]]//Flatten;*)fermother=Join[fermother[[;;-l\[Gamma]-1]],Times[#,fermother2]&/@fermother[[-l\[Gamma];;]]//Flatten];(*Do[fermcont[[-l\[Gamma];;,icon]]=Join[fermcont[[-l\[Gamma];;,icon]],#]&/@fermcont2,{icon,Length[fermcont\[LeftDoubleBracket]-l\[Gamma];;\[RightDoubleBracket]]}];fermcont[[-l\[Gamma];;]]=Flatten[fermcont[[-l\[Gamma];;]],1];*)fermcont=Join[fermcont[[;;-l\[Gamma]-1]],Flatten[Outer[Join,fermcont[[-l\[Gamma];;]],fermcont2,1],1]];

(*Print["{fermtensor,fermcont,fermother}=",l\[Gamma],{fermtensor,fermcont,fermother}];*)fermtensor2=fermother2=fermcont2={}],{lcur,fermcur[1/2]}](***************)];If[fermtensor[[1,0]]===List,fermtensor=Flatten[fermtensor,1];fermother=Flatten[fermother,1];fermcont=Flatten[fermcont,1]]
