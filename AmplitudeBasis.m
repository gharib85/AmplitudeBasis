...
Do[group=CheckGroup[model,groupname];Check[tSimp[group]/.{INDEXSET->Catenate@model["rep2indOut"]}//ReleaseHold,"simplification rule for "<>ToString[groupname]<>" not found"],{groupname,model["Gauge"]}];
Protect[Times]
]
...
OpBasis=transform[#,ReplaceField->{model,type,OptionValue[FerCom]},OpenFchain->OptionValue[OpenFchain],ActivatePrintTensor->OptionValue[ActivatePrintTensor]]&/@amp2op["LorBasis"];
If[OptionValue[Coord],
...
basis=transform[#,OpenFchain->OptionValue[finalform],ActivatePrintTensor->OptionValue[finalform]]&/@operbasis[[basispos]];
...
operab[a_]:=Module[{alist,oper=1,la},If[a===1,oper=1,alist=Prod2List[a];la=Length[alist];Do[oper*=Subscript[h2f[-1/2], #1][2,Alphabet["Greek"][[i]]]Subscript[h2f[-1/2], #2][1,Alphabet["Greek"][[i]]]&[alist[[i,1]],alist[[i,2]]],{i,la}]];oper];
...
h2f[1/2], #1][1,Alphabet["English"][[i]]]Subscript[
h2f[1/2], #2][2,Alphabet["English"][[i]]]&[slist[[i,1]],slist[[i,2]]],{i,ls}]];oper];
...
change[\[Psi]i_,\[Psi]bi_,i_,Greek_]:=Module[{l\[Psi],l\[Psi]b,ans1=\[Psi]i,ans2=\[Psi]bi,ans=1,iGreek=Greek},Switch[\[Psi]i[[0]],Times,l\[Psi]=Length[\[Psi]i],Integer,l\[Psi]=0,_,l\[Psi]=1];Switch[\[Psi]bi[[0]],Times,l\[Psi]b=Length[\[Psi]bi],Integer,l\[Psi]b=0,_,l\[Psi]b=1];Switch[l\[Psi]-l\[Psi]b,0,Switch[l\[Psi],0,ans=Subscript[\[Phi], i],1,ans1[[0]]=\[Psi];ans2[[0]]=\[Psi];ans=\[Psi][ans1,ans2];ans[[0]]=("\[Sigma]"^Alphabet["Greek"][[iGreek]]);ans=ans (Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]] Subscript[h2f[0], i]);iGreek++,_,Do[ans=ans Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[a,1]],ans1[[a,2]],ans2[[a,1]],ans2[[a,2]]];iGreek++,{a,l\[Psi]}];ans=ans Subscript[h2f, i]],1,Switch[l\[Psi]b,0,ans1[[0]]=Subscript[h2f[-1/2], i];ans=ans1,1,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[1,1]],ans1[[1,2]],ans2[[1]],ans2[[2]]] Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]Subscript[h2f[-1/2], i][ans1[[2,1]],ans1[[2,2]]];iGreek++,_,Do[ans=ans Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[a,1]],ans1[[a,2]],ans2[[a,1]],ans2[[a,2]]];iGreek++,{a,l\[Psi]b}];ans=ans Subscript[h2f[-1/2], i][ans1[[l\[Psi],1]],ans1[[l\[Psi],2]]]],-1,Switch[l\[Psi],0,ans2[[0]]=Subscript[
h2f[1/2], i];ans=ans2,1,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[1]],ans1[[2]],ans2[[1,1]],ans2[[1,2]]]Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]Subscript[
h2f[1/2], i][ans2[[2,1]],ans2[[2,2]]];iGreek++,_,Do[ans=ans Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[a,1]],ans1[[a,2]],ans2[[a,1]],ans2[[a,2]]];iGreek++,{a,l\[Psi]}];ans=ans Subscript[
h2f[1/2], i][ans2[[l\[Psi]b,1]],ans2[[l\[Psi]b,2]]]],2,Switch[l\[Psi]b,0,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[1,1]],ans1[[1,2]],2,Alphabet["English"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[ans1[[2,1]],ans1[[2,2]],1,Alphabet["English"][[iGreek]]]Subscript[Subscript[Subscript[h2f[-1], i], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]];iGreek+=2,1,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[1,1]],ans1[[1,2]],ans2[[1]],ans2[[2]]]Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[ans1[[2,1]],ans1[[2,2]],2,Alphabet["English"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+2]])[ans1[[3,1]],ans1[[3,2]],1,Alphabet["English"][[iGreek]]]Subscript[Subscript[Subscript[h2f[-1], i], Alphabet["Greek"][[iGreek+1]]], Alphabet["Greek"][[iGreek+2]]];iGreek+=3,_,Do[ans=ans Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[a,1]],ans1[[a,2]],ans2[[a,1]],ans2[[a,2]]];iGreek++,{a,l\[Psi]b}];ans=ans ("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[l\[Psi]-1,1]],ans1[[l\[Psi]-1,2]],2,Alphabet["English"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[ans1[[l\[Psi],1]],ans1[[l\[Psi],2]],1,Alphabet["English"][[iGreek]]]Subscript[Subscript[Subscript[h2f[-1], i], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]];iGreek+=2],-2,Switch[l\[Psi],0,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[2,Alphabet["Greek"][[iGreek]],ans2[[1,1]],ans2[[1,2]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[1,Alphabet["Greek"][[iGreek]],ans2[[2,1]],ans2[[2,2]]]Subscript[Subscript[Subscript[h2f[1], i], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]];iGreek+=2,1,ans=("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[1]],ans1[[2]],ans2[[1,1]],ans2[[1,2]]]Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[2,Alphabet["Greek"][[iGreek]],ans2[[2,1]],ans2[[2,2]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+2]])[1,Alphabet["Greek"][[iGreek]],ans2[[3,1]],ans2[[3,2]]]Subscript[Subscript[Subscript[h2f[1], i], Alphabet["Greek"][[iGreek+1]]], Alphabet["Greek"][[iGreek+2]]];iGreek+=3,_,Do[ans=ans Subscript[Subscript[D, i], Alphabet["Greek"][[iGreek]]]("\[Sigma]"^Alphabet["Greek"][[iGreek]])[ans1[[a,1]],ans1[[a,2]],ans2[[a,1]],ans2[[a,2]]];iGreek++,{a,l\[Psi]}];ans=ans ("\[Sigma]"^Alphabet["Greek"][[iGreek]])[2,Alphabet["Greek"][[iGreek]],ans2[[l\[Psi]b-1,1]],ans2[[l\[Psi]b-1,2]]]("\[Sigma]"^Alphabet["Greek"][[iGreek+1]])[1,Alphabet["Greek"][[iGreek]],ans2[[l\[Psi]b,1]],ans2[[l\[Psi]b,2]]]Subscript[Subscript[Subscript[h2f[1], i], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]];iGreek+=2],_,Print["spin over 1"]];{ans,iGreek}];
changesp[\[Psi]i_,\[Psi]bi_,i_]:=Module[{l\[Psi],l\[Psi]b,ans1=\[Psi]i,ans2=\[Psi]bi,ans=1,head,label},Switch[\[Psi]i[[0]],Times,l\[Psi]=Length[\[Psi]i],Integer,l\[Psi]=0,_,l\[Psi]=1];Switch[\[Psi]bi[[0]],Times,l\[Psi]b=Length[\[Psi]bi],Integer,l\[Psi]b=0,_,l\[Psi]b=1];Switch[l\[Psi]-l\[Psi]b,0,Switch[l\[Psi],0,ans=Subscript[h2f[0], i],1,ans1[[0]]=\[Psi];ans2[[0]]=\[Psi];ans=\[Psi][ans1,ans2];ans[[0]]=ch[D, Subscript[h2f[0], i]],_,ans1=\[Psi]@@@ans1;ans2=\[Psi]@@@ans2;ans=\[Psi]@@(ans1*ans2);ans[[0]]=ch[D^l\[Psi],Subscript[h2f[0], i]]],1,Switch[l\[Psi]b,0,ans1[[0]]=Subscript[h2f[-1/2], i];ans=ans1,1,ans=ch[D,Subscript[h2f[-1/2], i]][ans1[[1,1]],ans1[[1,2]],ans1[[2,1]],ans1[[2,2]],ans2[[1]],ans2[[2]]] ,_,ans1=\[Psi]@@@ans1;ans2=\[Psi]@@@ans2;ans=\[Psi]@@(ans1*ans2);ans[[0]]=ch[D^l\[Psi]b,Subscript[h2f[-1/2], i]]],-1,Switch[l\[Psi],0,ans2[[0]]=Subscript[
h2f[1/2], i];ans=ans2,1,ans=ch[D,Subscript[
h2f[1/2], i]][ans1[[1]],ans1[[2]],ans2[[1,1]],ans2[[1,2]],ans2[[2,1]],ans2[[2,2]]],_,ans1=\[Psi]@@@ans1;ans2=\[Psi]@@@ans2;ans=\[Psi]@@(ans1*ans2);ans[[0]]=ch[D^l\[Psi],Subscript[
h2f[1/2], i]]],2,Switch[l\[Psi]b,0,ans=Subscript[h2f[-1], i][ans1[[1,1]],ans1[[1,2]],ans1[[2,1]],ans1[[2,2]]],1,ans=ch[D,Subscript[h2f[-1], i]][ans1[[1,1]],ans1[[1,2]],ans1[[2,1]],ans1[[2,2]],ans1[[3,1]],ans1[[3,2]],ans2[[1]],ans2[[2]]],_,ans1=\[Psi]@@@ans1;ans2=\[Psi]@@@ans2;ans=\[Psi]@@(ans1*ans2);ans[[0]]=ch[D^l\[Psi]b,Subscript[h2f[-1], i]]],-2,Switch[l\[Psi],0,ans=Subscript[h2f[1], i][ans2[[1,1]],ans2[[1,2]],ans2[[2,1]],ans2[[2,2]]],1,ans=ch[D,Subscript[h2f[1], i]][ans1[[1]],ans1[[2]],ans2[[1,1]],ans2[[1,2]],ans2[[2,1]],ans2[[2,2]],ans2[[3,1]],ans2[[3,2]]],_,ans1=\[Psi]@@@ans1;ans2=\[Psi]@@@ans2;ans=\[Psi]@@(ans1*ans2);ans[[0]]=ch[D^l\[Psi],Subscript[h2f[1], i]]],_,Print["spin over 1"]];head=ans[[0]];If[head===Subscript,label=0;head=ans,label=Length[ans]/2];Do[If[ans[[1]]===1,head=Subscript[head,ans[[2]]],head=Superscript[head,ans[[2]]]];ans=Delete[ans,{{1},{2}}],{ii,label}];head];
...
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"}];\[Sigma]2[a_,iGreek_]:={{Superscript["g",a[[1,1]] a[[2,1]]],-I},{1,"\[Sigma]"[a[[1,1]],a[[2,1]]]},{iGreek}};(* where \[Sigma]^\[Mu]\[Nu]=(i/2)[\[Gamma]^\[Mu],\[Gamma]^\[Nu]]~(i/2)(\[Sigma]^\[Mu]Overscript[\[Sigma], _]^\[Nu]-\[Sigma]^\[Nu]Overscript[\[Sigma], _]^\[Mu]) *)\[Sigma]3[a_,iGreek_,sign_:1]:=Module[{e=DeleteCases[Alphabet["Greek"],"\[Sigma]"][[iGreek]]},{{Superscript["g",a[[1,1]] a[[2,1]]],-Superscript["g",a[[1,1]] a[[3,1]]],Superscript["g",a[[2,1]] a[[3,1]]],I sign Signature[{a[[1,1]],a[[2,1]],a[[3,1]],e}]Superscript["\[Epsilon]",a[[1,1]]a[[2,1]]a[[3,1]]e]},{"\[Sigma]"[a[[3,1]]],"\[Sigma]"[a[[2,1]]],"\[Sigma]"[a[[1,1]]],"\[Sigma]"[e]},{iGreek+1}}];
...
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[q1_,j_],q_]},{Subscript[Subscript[D, a], i],Subscript[Subscript[Subscript[h2f[-1], a], i], q],Subscript[Subscript[Subscript[h2f[-1], a], q], i],Subscript[Subscript[Subscript[h2f[1], a], i], q],Subscript[Subscript[Subscript[h2f[1], a], q], i],ch\[Psi][p,"\[Sigma]"[i],q],ch\[Psi][p,
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[i],q],ch\[Psi][p,"\[Sigma]"[i,q1],q],ch\[Psi][p,
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[i,q1],q],ch\[Psi][p,"\[Sigma]"[q1,i],q],ch\[Psi][p,
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[q1,i],q]}}],Superscript["g",i_ j_]Superscript["\[Epsilon]",j_ k_ l_ m_]:>Signature[{i,k,l,m}] Signature[{j,k,l,m}] Superscript["\[Epsilon]",i k l m],Subscript[Subscript[Subscript[h2f[-1], k_], i_], j_]Superscript["\[Epsilon]",i_ j_ a_ b_]:>2I Subscript[Subscript[Subscript[h2f[-1], k], a], b]Signature[{i,j,a,b}],Subscript[Subscript[Subscript[h2f[1], k_], i_], j_]Superscript["\[Epsilon]",i_ j_ a_ b_]:>-2I Subscript[Subscript[Subscript[h2f[1], k], a], b]Signature[{i,j,a,b}],Superscript["\[Epsilon]",i1_ j1_ k1_ l1_]Superscript["\[Epsilon]",i2_ j2_ k2_ l2_]:>epsilon2[{i1,j1,k1,l1},{i2,j2,k2,l2}],Superscript["g",i_ j_]Superscript["g",i_ k_]:>Superscript["g",j k],Superscript["g",i_ i_]:>4,Superscript["g",i_ j_]Superscript["g",i_ j_]:>4}//Flatten;(* let Subscript[F, label] or Subscript[Overscript[F, _], label] absorb redundant epsilon *)Ftilde[iGreek_]:={Subscript[Subscript[Subscript[h2f[-1], label_], i_], j_]Superscript["\[Epsilon]",a_ b_ c_ d_]:>-I/2 Subscript[Subscript[Subscript[h2f[-1], label], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]]epsilon2[{i,j,Alphabet["Greek"][[iGreek]],Alphabet["Greek"][[iGreek+1]]},{a,b,c,d}],Subscript[Subscript[Subscript[h2f[1], label_], i_], j_]Superscript["\[Epsilon]",a_ b_ c_ d_]:>I/2 Subscript[Subscript[Subscript[h2f[1], label], Alphabet["Greek"][[iGreek]]], Alphabet["Greek"][[iGreek+1]]]epsilon2[{i,j,Alphabet["Greek"][[iGreek]],Alphabet["Greek"][[iGreek+1]]},{a,b,c,d}]};
(* redefine the index *)
...
Dcontract1={MapThread[MapThread[{Subscript[Subscript[D, i_], j_]#1:>#2,Superscript[Subscript[D, i_],j_]#1:>#3}&,{{#1,ch[p__,#1]},{ch[Subscript[D, j],#2],ch[p,Subscript[D, j],#2]},{ch[Superscript[D,j],#2],ch[p,Superscript[D,j],#2]}}]&,{{Subscript[h2f[0], i_],Subscript[h2f[-1], i_][q__],Subscript[h2f[1], i_][q__]},{Subscript[h2f[0], i],Subscript[h2f[-1], i][q],Subscript[h2f[1], i][q]}}]}//Flatten;
...
OperSpMonoResp[a_:1,s_:1,n_]:=Module[{opA,opS,\[Psi]i=Table[1,{i,n},{j,2}],op=1,lop,index,opi,coef,chain={},chainnum={},indexa,index\[Alpha],lchain,\[Sigma]m,oper},opA=operab[a];opS=opersb[s];Do[\[Psi]i[[i,1]]=Cases[opA,Subscript[h2f[-1/2], i][_Integer,_]];\[Psi]i[[i,1,0]]=Times;\[Psi]i[[i,2]]=Cases[opS,Subscript[h2f[1/2], i][_Integer,_]];\[Psi]i[[i,2,0]]=Times,{i,n}];Do[opi=changesp[\[Psi]i[[i,1]],\[Psi]i[[i,2]],i];op=op opi,{i,n}];op];
...
OperPoly[A_,n_,OptionsPattern[]]:=Module[{operpoly,form,form1,form2,ten,tAssumptions},
If[OptionValue[LorForm],
operpoly=Thread[head[A,n],Plus]/.{head->OperMono};If[operpoly[[0]]===Plus,operpoly=List@@operpoly;form=tensorform/@operpoly;form1=Union@@form[[All,2]];form2=Union@@form[[All,3]];tAssumptions={epsilon\[Element]Arrays[{4,4,4,4},Antisymmetric[{1,2,3,4}]]}\[Union](antisym/@form2)\[Union](sym/@form1)//Flatten;ten=Map[TensorReduce[#,Assumptions->tAssumptions]&,Plus@@form[[All,1]]//Simplify,{2,3}]//Expand;operpoly=Thread[head[ten],Plus]/.{head->tensortooper},
form=Map[TensorReduce[#,Assumptions->tAssumptions]&,tensorform[operpoly],2];operpoly=tensortooper[form[[1]]]];If[OptionValue[Dcontract],operpoly=operpoly//.Flatten[{Dcontract1,Dcontract2}],operpoly],operpoly=Thread[head[A,n],Plus]/.{head->OperSpMono}]
]
...
antichange[PartofAmp_,Greek_]:=Module[{spinor,particle},Switch[PartofAmp,Subscript[D, _][_],particle=PartofAmp[[0,2]];spinor=-I/2*Subscript[h2f[-1/2], particle][1,Alphabet["Greek"][[Greek]]]Subscript[
h2f[1/2], particle][1,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[1]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]];Greek++,Subscript[h2f[-1], _][__],particle=PartofAmp[[0,2]];spinor=1/4*Subscript[h2f[-1/2], particle][1,Alphabet["Greek"][[Greek]]]Subscript[h2f[-1/2], particle][1,Alphabet["Greek"][[Greek+1]]]"\[Sigma]"[PartofAmp[[2]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[4]]][2,Alphabet["Greek"][[Greek+1]],1,Alphabet[][[Greek]]];Greek+=2,Subscript[h2f[1], _][__],particle=PartofAmp[[0,2]];spinor=1/4*Subscript[h2f[1/2], particle][1,Alphabet[][[Greek]]]Subscript[h2f[1/2], particle][1,Alphabet[][[Greek+1]]]"\[Sigma]"[PartofAmp[[2]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[4]]][1,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek+1]]];Greek+=2,ch\[Psi][Subscript[h2f[-1/2], _],1,Subscript[h2f[-1/2], _]],spinor=PartofAmp[[1]][2,Alphabet["Greek"][[Greek]]]PartofAmp[[3]][1,Alphabet["Greek"][[Greek]]];Greek++,ch\[Psi][Subscript[h2f[1/2], _],1,Subscript[h2f[1/2], _]],spinor=PartofAmp[[1]][1,Alphabet[][[Greek]]]PartofAmp[[3]][2,Alphabet[][[Greek]]];Greek++,ch\[Psi][Subscript[h2f[-1/2], _],"\[Sigma]"[_]|"\[Gamma]"[_],Subscript[
h2f[1/2], _]],spinor=PartofAmp[[1]][2,Alphabet["Greek"][[Greek]]]"\[Sigma]"[PartofAmp[[2,1]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek]]]PartofAmp[[3]][2,Alphabet[][[Greek]]];Greek++,ch\[Psi][Subscript[
h2f[1/2], _],
"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[_]|"\[Gamma]"[_],Subscript[h2f[-1/2], _]],spinor=PartofAmp[[1]][1,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2,1]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]PartofAmp[[3]][1,Alphabet["Greek"][[Greek]]];Greek++,ch\[Psi][Subscript[h2f[-1/2], _],"\[Sigma]"[__],Subscript[h2f[-1/2], _]],spinor=I/2*PartofAmp[[1]][2,Alphabet["Greek"][[Greek]]]("\[Sigma]"[PartofAmp[[2,1]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2,2]]][2,Alphabet["Greek"][[Greek+1]],2,Alphabet[][[Greek]]]-"\[Sigma]"[PartofAmp[[2,2]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2,1]]][2,Alphabet["Greek"][[Greek+1]],2,Alphabet[][[Greek]]])PartofAmp[[3]][1,Alphabet["Greek"][[Greek+1]]];Greek+=2,ch\[Psi][Subscript[h2f[1/2], _],"\!\(\*OverscriptBox[\(\[Sigma]\), \(_\)]\)"[__],Subscript[h2f[1/2], _]],spinor=I/2*PartofAmp[[1]][1,Alphabet[][[Greek]]]("\[Sigma]"[PartofAmp[[2,1]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2,2]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek+1]]]-"\[Sigma]"[PartofAmp[[2,2]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2,1]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek+1]]])PartofAmp[[3]][2,Alphabet[][[Greek+1]]];Greek+=2,"\[Epsilon]"[__],spinor=I/4("\[Sigma]"[PartofAmp[[1]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek+1]]]"\[Sigma]"[PartofAmp[[3]]][2,Alphabet["Greek"][[Greek+1]],2,Alphabet[][[Greek+1]]]"\[Sigma]"[PartofAmp[[4]]][1,Alphabet["Greek"][[Greek+1]],1,Alphabet[][[Greek]]]-"\[Sigma]"[PartofAmp[[1]]][1,Alphabet["Greek"][[Greek]],1,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[2]]][2,Alphabet["Greek"][[Greek+1]],2,Alphabet[][[Greek]]]"\[Sigma]"[PartofAmp[[3]]][1,Alphabet["Greek"][[Greek+1]],1,Alphabet[][[Greek+1]]]"\[Sigma]"[PartofAmp[[4]]][2,Alphabet["Greek"][[Greek]],2,Alphabet[][[Greek+1]]]);Greek+=2,Subscript[h2f[0], _],spinor=1,_,spinor=PartofAmp];(*Print[spinor];*)spinor];\[Sigma]contract={"\[Sigma]"[\[Mu]_][n1_,\[Alpha]_,n2_,a_]"\[Sigma]"[\[Mu]_][n3_,\[Beta]_,n4_,b_]:>(-1)^(n3+n4) 2\[Epsilon][n1,\[Alpha],n3,\[Beta]]\[Epsilon][n2,a,n4,b]};
\[Epsilon]contract={\[Epsilon][n1_,\[Alpha]_,n2_,\[Beta]_]Subscript[h2f[-1/2], i_][n3_,\[Beta]_]:>Subscript[h2f[-1/2], i][n1,\[Alpha]],\[Epsilon][n1_,a_,n2_,b_]Subscript[h2f[1/2], i_][n3_,b_]:>Subscript[h2f[1/2], i][n1,a],\[Epsilon][n1_,a_,n2_,b_]\[Epsilon][n3_,b_,n4_,c_]:>\[Epsilon][n1,a,n4,c],\[Epsilon][n1_,a_,n2_,b_]\[Epsilon][n3_,c_,n4_,b_]:>(-1)^(n3+n4+1) \[Epsilon][n1,a,n3,c],\[Epsilon][n1_,b_,n2_,a_]\[Epsilon][n3_,b_,n4_,c_]:>(-1)^(n1+n2+1) \[Epsilon][n2,a,n4,c],\[Epsilon][n1_,a_,n2_,a_]:>2};
asbracket={Subscript[h2f[-1/2], i_][2,a_]Subscript[h2f[-1/2], j_][1,a_]:>ab[i,j],Subscript[h2f[1/2], i_][1,a_]Subscript[h2f[1/2], j_][2,a_]:>sb[i,j]};
...
(*]*)
(**)
(*nonFund2Fund[model_,groupname_,rep_,flag_:False]:=Module[{group=CheckGroup[groupname],indexFund},indexFund=model[rep2ind][groupname][Fund[group]];*)
...
(*GenerateLRRP[model_,groupname_,nonsinglets_]:=Module[{nfield=nonsinglets[[1]],SUNirrep=nonsinglets[[2]],fname=nonsinglets[[3]],fnlist,nfund,index},*)
(*nfund=Total[Dynk2Yng[SUNirrep]];*)
(*If[nfield==1,{},*)
(*fnlist=Array[fname<>ToString[#]&,nonsinglets[[1]]];*)
(*index=nonFund2Fund[model,groupname,SUNirrep,StringTake[fname,-1]=="\[Dagger]"];(* get appropriate index name *)*)
...
RMDelta[in_]:=Module[{rule,delTlist=Select[Keys[tOut], StringMatchQ[ToString[#],"del"~~__]&],func},
...
groupB=GetGroupFactor[model,#,type,OutputMode->"indexed"]&/@Select[model["Gauge"],nonAbelian];
